...
import { Member } from 'apps/watches-api/src/libs/dto/member/member';
import { Property } from 'apps/watches-api/src/libs/dto/property/property';
import { MemberStatus, MemberType } from 'apps/watches-api/src/libs/enums/member.enum';
import { PropertyStatus } from 'apps/watches-api/src/libs/enums/property.enum';
	...
	public async batchRollback(): Promise<void> {
		...
		await this.propertyModel
			.updateMany(
				...
				{ propertyRank: 0 }, // MongoDB dataset "0" ga tenglayapmiz
			)
			.exec();
		...
		await this.memberModel
			.updateMany(
				...
				{ memberRank: 0 }, // MongoDB dataset "0" ga tenglayapmiz
			)
			.exec();
	}
