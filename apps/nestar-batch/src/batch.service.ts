...
import { Property } from 'apps/watch-api/src/libs/dto/property/property';
import { MemberStatus, MemberType } from 'apps/watch-api/src/libs/enums/member.enum';
import { PropertyStatus } from 'apps/watch-api/src/libs/enums/property.enum';
...
export class BatchService {
	...
	public getHello(): string {
		return 'Welcome to watch BATCH server!';
	}
}
